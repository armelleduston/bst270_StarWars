...
packages <- c("ggplot2", "dplyr", "forcats")
...
Import data from "StarWars.csv". Raw data has column names on two different rows, manually define column-names and remove spaces
```{r}
